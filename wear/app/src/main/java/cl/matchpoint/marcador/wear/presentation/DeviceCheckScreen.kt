 ...
 *
 * Ya no está en el arranque (desde la Fase 3 ahí va el marcador); se deja para
 * mirarla en un `@Preview` o volver a enchufarla cuando aparezca un reloj distinto.
 */
@Composable
